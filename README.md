...
- Loading에 관여하는 Thread 5개를 Thread Pool에사 가져와서 로드한다. (ThreadPool.h)
# Render Thread 분리
...
- 간단하게 분리하게된 이유를 설명하자면 D3D11의 Device와 Context는 멀티스레드 접근을 지원해주지 않기 때문에 Deffered Context를 활용했었는데..
