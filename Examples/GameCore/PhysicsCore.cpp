...
void PhysicsCore::InitPhysEngine()
{
	PhysicsCore::CreateEmptyDynamicsWorld(m_collisionConfiguration, m_dispatcher, m_broadphase, m_solver, m_dynamicsWorld);
	if (m_dynamicsWorld->getDebugDrawer())
		m_dynamicsWorld->getDebugDrawer()->setDebugMode(btIDebugDraw::DBG_DrawWireframe + btIDebugDraw::DBG_DrawContactPoints);

}
void PhysicsCore::CreateEmptyDynamicsWorld(btDefaultCollisionConfiguration*& OutCollisionCofiguration,
...
btBoxShape* PhysicsCore::CreateBoxShape(const btVector3& halfExtents)
{
	btBoxShape* box = new btBoxShape(halfExtents);
	return box;
}

btRigidBody* PhysicsCore::CreateRigidBody(float mass,
...
void PhysicsCore::RemoveRigidBody(btRigidBody* InRigidBody)
{
	m_dynamicsWorld->removeRigidBody(InRigidBody);
}

void PhysicsCore::StepSimulation(float InDeltaTime)
{
	if (m_dynamicsWorld)
	{
...
void PhysicsCore::RegisterPhysMap(btCollisionObject* InRigidBody, std::weak_ptr<Object> InObject)
{
...
void PhysicsCore::RemovePhysMap(btCollisionObject* InRigidBody)
{
...
std::weak_ptr<Object> PhysicsCore::GetPhysObject(btCollisionObject* InRigidBody)
{
	if (m_physMap.find(InRigidBody) == m_physMap.end())
	{
...
btCollisionObject* PhysicsCore::GetCollisionObject(int InObjId)
{
